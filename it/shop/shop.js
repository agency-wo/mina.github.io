...
//         SQ prints Lek first. Nothing ships in one language: all three change
//         in one edit.
(function(){
  ...
  function fmt(price, currency){
    if(!price) return '<span class="por">Prezzo su richiesta</span>';
  ...
  function waMsg(w){
    var msg = "Salve, sono interessato all'orologio " + w.brand + ' ' + w.model + (w.reference ? ' (Rif. ' + w.reference + ')' : '') + ' sul vostro sito.';
