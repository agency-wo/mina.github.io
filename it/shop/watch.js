(function(){
  ...
  function render(w){
    ...
    var title = _nm + (w.price ? ' - €' + w.price : '') + ' | Orologi a Durazzo';
    ...
    var bc = {
      ...
      'itemListElement': (function(){
        ...
        var _out = [
          {'@type': 'ListItem', 'position': 1, 'name': 'Home', 'item': 'https://watch.al/it/'},
          {'@type': 'ListItem', 'position': 2, 'name': 'Negozio', 'item': 'https://watch.al/it/shop/'}
        ];
        if (_s) { _out.push({'@type': 'ListItem', 'position': 3, 'name': w.brand,
          'item': 'https://watch.al/it/shop/brand/' + _s + '.html'}); }
