...
COPY = {
    ...
    "navimarine": {
        "en": {
            "paras": [
                ...
                "Water resistance is officially stated only on the Steel 5ATM Blue and the NT0021-1, both rated 5 ATM, which is fine for swimming at the surface. For any other model, ask us before you take it near water and we will tell you what we know.",
            ],
            "faq": [
        ...
        "it": {
            "paras": [
                ...
                "La resistenza all’acqua è dichiarata ufficialmente solo sullo Steel 5ATM Blue e sul NT0021-1, entrambi certificati 5 ATM, adatti al nuoto in superficie. Per ogni altro modello chiedeteci prima di avvicinarlo all’acqua e vi diremo quello che sappiamo.",
            ],
            "faq": [
        ...
        "sq": {
            "paras": [
                ...
                "Rezistenca ndaj ujit deklarohet zyrtarisht vetëm te Steel 5ATM Blue dhe te NT0021-1, të dyja të certifikuara 5 ATM, të përshtatshme për not në sipërfaqe. Për çdo model tjetër na pyesni para se ta afroni te uji dhe ju themi atë që dimë.",
            ],
            "faq": [
    ...
    "philippe-lauren": {
        "en": {
            "paras": [
                "Philippe Lauren puts quite different watches under one name, in Durrës from €{lo} to €{hi}: three-counter chronographs, plain steel dress watches, steel sport watches with a faceted bezel and an integrated bracelet, and gold-tone dress watches.",
                "The chronographs share the same layout: three sub-dials, pushers on the case side and a date window, in polished steel and black ion-plated steel, and one of them sits in a square cushion case that is the most distinctive shape we sell. The Steel Sport models share a faceted bezel, four visible screws and an integrated steel bracelet, one with a black textured dial and Roman numerals at 12 and 6, the newer one with a deep blue sunburst dial, three sub-dials and pushers on the case side. We describe that one by what is on its dial, because we call a watch a chronograph only after we have confirmed it ourselves.",
                "The steel dress watches are where the range now starts and they are the plainest of it: no date, no sub-dials, a slim bracelet. One is round with a crystal-set bezel in two rows and a deep blue sunburst dial with crystal indices, one is round with a plain polished bezel and a silver sunburst dial, and one is rectangular with bevelled cut corners. The gold-tone dress watches are a square case with a crystal-set bezel, a silver dial and black Roman numerals, and a small round case with a silver sunburst dial on a five-link bracelet. The gold tone is plating rather than solid gold, so keep it out of salt water. We do not publish a movement or a water-resistance rating for Philippe Lauren, so ask us about the exact model and we will tell you what we know. Every one comes with our 1-year guarantee, cash on delivery across Albania.",
            ],
            "faq": [
                ("What kind of watches is Philippe Lauren?",
                 "It is several kinds of watch under one name, from €{lo} to €{hi}: three-counter chronographs with a date window, plain steel dress watches with no date and no sub-dials, steel sport watches with a faceted bezel and an integrated bracelet, and gold-tone dress watches. The cases and bracelets are stainless steel, with black ion plating on the darker models."),
        ...
        "it": {
            "paras": [
                "Philippe Lauren mette orologi molto diversi tra loro sotto un solo nome, a Durazzo da €{lo} a €{hi}: cronografi a tre contatori, orologi da abito in acciaio essenziali, sportivi in acciaio con ghiera sfaccettata e bracciale integrato, e orologi da abito color oro.",
                "I cronografi hanno lo stesso schema: tre contatori, pulsanti sul lato della cassa e una finestrella data, in acciaio lucido e in acciaio placcato nero, e uno di loro sta in una cassa quadrata a cuscino, la forma più riconoscibile che vendiamo. I modelli Steel Sport condividono ghiera sfaccettata, quattro viti a vista e bracciale integrato in acciaio: uno ha quadrante nero testurizzato con numeri romani alle 12 e alle 6, il più recente ha quadrante blu intenso sunburst, tre contatori e pulsanti sul lato della cassa. Lo descriviamo per quello che c’è sul suo quadrante, perché chiamiamo cronografo un orologio solo dopo averlo verificato noi.",
                "Gli orologi da abito in acciaio sono il punto in cui oggi comincia la gamma e la sua parte più essenziale: niente data, niente contatori, bracciale sottile. Uno è rotondo, con ghiera con cristalli su due file e quadrante blu intenso sunburst con indici con cristalli; uno è rotondo con ghiera lucida liscia e quadrante argentato sunburst; e uno ha cassa rettangolare con angoli smussati. Gli orologi da abito color oro sono una cassa quadrata con ghiera con cristalli, quadrante argentato e numeri romani neri, e una piccola cassa rotonda con quadrante argentato sunburst su bracciale a cinque maglie. Il color oro è una placcatura e non oro massiccio, quindi tenetelo lontano dall’acqua salata. Per Philippe Lauren non pubblichiamo né il movimento né una certificazione di impermeabilità, quindi chiedeteci del modello esatto e vi diremo quello che sappiamo. Ognuno ha la nostra garanzia di 1 anno, con pagamento alla consegna in tutta l’Albania.",
            ],
            "faq": [
                ("Che tipo di orologi è Philippe Lauren?",
                 "Sono diversi tipi di orologio sotto un solo nome, da €{lo} a €{hi}: cronografi a tre contatori con finestrella data, orologi da abito in acciaio senza data e senza contatori, sportivi in acciaio con ghiera sfaccettata e bracciale integrato, e orologi da abito color oro. Casse e bracciali sono in acciaio inossidabile, con placcatura nera sui modelli più scuri."),
